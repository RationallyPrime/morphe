...
| stripped viewer and grammar fail-closed gate | shipped | `viewer/` config-declared browse space (`/`, `/surfaces`, `/s/[source]/[surfaceId]`, `/healthz`); version+fingerprint identity |
