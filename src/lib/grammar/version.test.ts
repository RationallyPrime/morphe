...
import { GRAMMAR_FINGERPRINT, GRAMMAR_VERSION } from "./version.js";
...
describe("GRAMMAR_VERSION parity", () => {
	...
	it("exports the generated grammar fingerprint", () => {
		expect(GRAMMAR_FINGERPRINT.startsWith("sha256:")).toBe(true);
		expect(GRAMMAR_FINGERPRINT).toHaveLength("sha256:".length + 64);
	});
});
