...
**One schema, three jobs — partial.** Projection M's schema source and code-generation jobs
...
The third job — genuine per-dialect `G|D` constrained-decoding artifacts and a
structured slow-loop emission through them — remains open.
